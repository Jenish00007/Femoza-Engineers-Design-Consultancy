  ...
  const projectCategories = [
    {
      ...
      projects: [
        { name: "Luxury Villa Complex", details: "High-end residential development with sustainable design features" },
        { name: "Affordable Housing Project", details: "200-unit development with optimized construction workflows" },
        { name: "Mixed-Use Residential", details: "Combined residential and retail spaces with integrated MEP systems" }
      ]
    },
    {
      ...
      projects: [
        { name: "Corporate Headquarters", details: "40-story office tower with advanced structural coordination" },
        { name: "Shopping Mall Complex", details: "Large-scale retail development with complex MEP integration" },
        { name: "Business Park", details: "Multi-building commercial campus with unified BIM workflow" }
      ]
    },
    {
      ...
      projects: [
        { name: "Manufacturing Plant", details: "Specialized equipment modeling with safety compliance" },
        { name: "Warehouse Facility", details: "Large-scale storage facility with automated systems integration" },
        { name: "Processing Center", details: "Industrial facility with complex piping and electrical systems" }
      ]
    },
    {
      ...
      projects: [
        { name: "Highway Bridge", details: "Major transportation infrastructure with environmental analysis" },
        { name: "Public Transit Station", details: "Modern transit hub with integrated smart systems" },
        { name: "Utility Infrastructure", details: "Large-scale utility network with IoT integration" }
      ]
    },
    {
      ...
      projects: [
        { name: "Historic Building Renovation", details: "Heritage structure restoration with modern BIM techniques" },
        { name: "Office Building Retrofit", details: "Energy-efficient upgrades with minimal disruption" },
        { name: "Industrial Facility Modernization", details: "Equipment upgrades with precise as-built modeling" }
      ]
    }
  ];
